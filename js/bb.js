...
if (pathName === "/") {
  $(document).ready(function () {
    if ($("#bber-talk").length > 0) {
      var jsonUrl = "";
      jsonUrl =
        "https://6130-a00-7gs665pr6a99ae5b-1303923768.tcb.qcloud.la/json/bber.json";
      $.getJSON(jsonUrl + "?t=" + Date.parse(new Date()), function (res) {
        ...
        $.each(res.data, function (i, item) {
          ...
          bberHtml +=
            ...
            (i + 1) +
            '">' +
            '<a href="https://myblog-six.vercel.app/artitalk/" style="color: var(--font-color);/*font-weight: normal;*/">' +
            newdataTime +
            "： " +
            urlToLink(item.content) +
            "</a></li>";
        });
        $("#bber-talk").append(
          '<span class="index-talk-icon" style="margin-right: 5px"><svg viewBox="0 0 550 550" width="15" height="15"><path d="M448 0H64C28.7 0 0 28.7 0 64v288c0 35.3 28.7 64 64 64h96v84c0 7.1 5.8 12 12 12 2.4 0 4.9-.7 7.1-2.4L304 416h144c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64zm16 352c0 8.8-7.2 16-16 16H288l-12.8 9.6L208 428v-60H64c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16h384c8.8 0 16 7.2 16 16v288z"></path></svg></span><ul class="talk-list">' +
            bberHtml +
            "</ul>"
        );
      });
      function urlToLink(str) {
        ...
        var re_forimg =
          /\<[img|IMG].*?src=[\'|\"](https\:\/\/.*?(?:[\.jpg|\.jpeg|\.png|\.gif|\.bmp]))[\'|\"].*?[\/]?>/g;
